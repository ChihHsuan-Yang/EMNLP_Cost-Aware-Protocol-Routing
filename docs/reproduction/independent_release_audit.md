...
| 13 | NOTE | One internal hostname appears in provenance docs | `https://inference-api.alcf.anl.gov/...` appears once, in a provenance file documenting the serving endpoint. This looks intentional and is a public-facing facility URL, not a credential. Flagging for a deliberate keep/remove decision, not as a defect. | `docs/provenance/models_and_versions.md:225` |
